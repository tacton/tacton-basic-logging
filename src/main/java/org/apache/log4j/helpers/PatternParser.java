...
public class PatternParser {
    ...
    private static class ClassNamePatternConverter extends NamedPatternConverter {
    ...
    private static class CategoryPatternConverter extends NamedPatternConverter {
